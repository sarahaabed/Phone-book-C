...
void ReadFile(char szInputfile[25]); //heba
...
{
int startcol=20,currentcol=20,endcol=20,term=0,i;
//int index=0;
char key;
...
{
int startcol=col,currentcol=col,endcol=col,term=0,i;
//int index=0;
char key;
int row=r;
char *startptr,*currentptr,*endptr;
